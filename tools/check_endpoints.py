...
class Book:
    ...
    def ask_reach_bps(self) -> float:
        ...
        одинаковой ширины. Шаг цены задаётся парой «биржа + инструмент»
        (см. instrument_rules в config.yaml): по BTC/USDT он равен 0,01 USDT
        у Binance и 0,1 у Bybit, OKX и Kraken; по SOL/USDT - 0,01 у всех.
        В относительных величинах один шаг - это 0,001-0,013 б.п. для BTC
        и 0,99 б.п. для SOL, разница почти в сто раз. Поэтому сравнивать
        объём «по всем уровням» между инструментами нельзя: это разные
        ценовые окна. Фактический охват ещё и шире идеального, потому что
        уровни идут с пропусками, - его и меряем.
        """
