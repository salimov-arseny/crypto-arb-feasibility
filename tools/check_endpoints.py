...
class Book:
    ...
    def ask_reach_bps(self) -> float:
        ...
        но для биткоина по 76 000 сотня шагов - это 0,001 % цены, а для солана
        по 100 - целый процент. Поэтому сравнивать объём «по всем уровням»
        между инструментами нельзя: это разные ценовые окна.
        """
